# Contributing to Solidity Utilities
[heading__title]:
  #contributing-to-solidity-utilities
...
The text within this document are not _set in stone_ rules but guidelines, and much like other files maintained by Solidity Utilities the following may be edited via a _`Pull Request`_.
...
- [Style Guidelines][heading__style_guidelines]
  ...
  - [:chains: Solidity][heading__style_guidelines__solidity]
...
Review the [whole thing][branch__current__code_of_conduct] to see what is expected of those that maintain code with Solidity Utilities
...
[heading__style_guidelines__solidity]:
  #solidity-style-guidelines
  "&#x26d3 Style Guidelines for Solidity"
...
```Bash
_git_name='your-name'
_organization='solidity-utilities'
...
set _organization='solidity-utilities'
...
- While not required the following emoji_word may be used as the first _word_ of commit messages
  ...
  - :chains: `:chains:` for changes to Solidity files.
...
There may be _`orphan`_ branches utilized by solidity-utilities for separating Code to be included in other projects from Documentation and Usage Examples. Non-orphaned development branches are encouraged when adding features or fixing bugs.
...
[branch__current__network_members]:
  network/members
  "Perhaps you too may be counted amount those that have Forked repositories maintain by Solidity Utilities"

[branch__current__support]:
  SUPPORT.md
  "Best avenues for seeking support of Solidity Utilities"
...
[badge__issues]: https://img.shields.io/github/issues/solidity-utilities/.github.svg

[badge__contributors]: https://img.shields.io/github/forks/solidity-utilities/.github.svg?color=005571&label=Contributors
